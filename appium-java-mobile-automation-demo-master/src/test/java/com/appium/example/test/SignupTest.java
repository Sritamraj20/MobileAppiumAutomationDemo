...
public class SignupTest extends BaseTest {
	...
	public void testSignup() {
		...
		screen().getLoginScreen().tapOnSignUpContainer().signUp(emails().domain("startup.io").val(), PASSWORD,
				PASSWORD);
		assertEquals(uiComponent().getAlertScreen().getAlertTitle(), "Signed Up!");
		assertEquals(uiComponent().getAlertScreen().getAlertMessage(), "You successfully signed up!");
	}
}
